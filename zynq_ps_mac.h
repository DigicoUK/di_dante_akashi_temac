 ...
 */
#ifndef _ZYNQ_PS_MAC_H
#define _ZYNQ_PS_MAC_H
...
#define GEM_EFI			0x004C /* External FIFO Interface */
...
/* Bitfields in EFI */
#define GEM_ENEFI_OFFSET	0 /* External fifo interface value offset */
#define GEM_ENEFI_SIZE		1
...
#define MACB_EXTINT_OFFSET		15 /* Enable external interrupt */
#define MACB_EXTINT_SIZE		1
...
struct macb_config {
	...
	int	(*clk_init)(struct platform_device *pdev, int group, struct clk **pclk,
